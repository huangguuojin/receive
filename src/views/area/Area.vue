<template>
  <div>
    <el-row>
      <el-col :span="2" class="el-col title-ct"><strong class="title">区域列表</strong></el-col>
      ...
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-col :span="6" class="ec-col-6">
          <el-form-item label="活动时间">
            ...
            <el-col :span="11">
              <el-date-picker type="date" placeholder="选择时间" v-model="form.endTime"
                              style="width: 100%;"></el-date-picker>
            </el-col>
          </el-form-item>
        </el-col>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-button @click="handleClick(scope.row.id)" type="button" size="small" v-if = "scope.row.statusValue == 1">修改</el-button>
                <el-button type="button" size="small" @click="delClick(scope.row.id)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      loadData() {
        ...
        Vue.axios.post('/api/area/listall', this.form, {headers: {Authorization: Authorization}}).then(res => {
